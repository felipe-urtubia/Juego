...
void testAppServiceTransfersAreSeparatedFromMainOrchestrator() {
    const string transfersPath =
        resolveProjectPath("src/career/app_services_transfers.cpp");
...
void testAppServiceManagerIsSeparatedFromMainOrchestrator() {
    const string managerPath =
        resolveProjectPath("src/career/app_services_manager.cpp");
...
void testAppServiceCareerIsSeparatedFromMainOrchestrator() {
    const string careerPath =
        resolveProjectPath("src/career/app_services_career.cpp");

    expect(pathExists(careerPath),
